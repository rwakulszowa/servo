...
class PropertiesData(object):
    ...
    def declare_longhand(self, name, products="gecko,servo", derived_from=None, **kwargs):
        if not self.product in products:
            return
        derived_from = (derived_from or "").split()

        longand = Longhand(self.current_style_struct, name, derived_from=derived_from, **kwargs)
